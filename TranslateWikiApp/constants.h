...
// data structure which holds error messages by key 
#define alertMessages @{                                                  \
    @"NoName"       : @"You left the user name field empty"             , \
    @"Illegal"      : @"You provided an illegal user name"              , \
    @"NotExists"    : @"The user name you provided doesn't exist"       , \
    @"EmptyPass"    : @"You left the password field empty"              , \
    @"WrongPass"    : @"The password you provided is incorrect"         , \
    @"WrongPluginPass": @"Authentication plugin rejected the password"  , \
    @"Blocked"      : @"Can't login. User is blocked"                   , \
    @"Throttled"    : @"You've logged in too many times in a short time. Please wait 5 minutes.", \
